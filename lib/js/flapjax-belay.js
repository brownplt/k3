...
/* 
   ...
   I wish JavaScript had tuples.  This will have to do.
   Example:

    var doThings = capServer.restore(serialized);
...
*/
function postE(argsE) {
  var ws_e = receiver_e();
  argsE.transform_e(function(args) {
    args[0].post(args[1], function(result) { ws_e.sendEvent(result); });
  });
  return ws_e;
}
